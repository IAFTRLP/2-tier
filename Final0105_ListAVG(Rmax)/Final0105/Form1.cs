...
namespace Final0105
{
    public partial class Form1 : Form
    {
        ...
        {
            // TODO: 這行程式碼會將資料載入 'com_Per_Site.DataTable1' 資料表。您可以視需要進行移動或移除。
            this.dataTable1TableAdapter1.Fill(this.com_Per_Site.DataTable1);
            // TODO: 這行程式碼會將資料載入 'computer_info.DataTable1' 資料表。您可以視需要進行移動或移除。
            this.dataTable1TableAdapter.Fill(this.computer_info.DataTable1);
        ...
        //    try
        //    {
        //        this.dataTable1TableAdapter.FillBy(this.computer_info.DataTable1, ((int)(System.Convert.ChangeType(list2ToolStripTextBox.Text, typeof(int)))), countryToolStripTextBox1.Text);
        //    }
        //    catch (System.Exception ex)
        //    {
        //        System.Windows.Forms.MessageBox.Show(ex.Message);
        ...
        private void fillByToolStripButton1_Click_1(object sender, EventArgs e)
        {
            try
            {
                this.dataTable1TableAdapter.FillBy(this.computer_info.DataTable1, ((int)(System.Convert.ChangeType(listToolStripTextBox2.Text, typeof(int)))), countryToolStripTextBox1.Text);
            }
            catch (System.Exception ex)
            {
                System.Windows.Forms.MessageBox.Show(ex.Message);
        ...
        private void listToolStripLabel_Click(object sender, EventArgs e)
        {
        ...
        private void fillByToolStripButton2_Click(object sender, EventArgs e)
        {
            try
            {
                this.dataTable1TableAdapter1.FillBy(this.com_Per_Site.DataTable1, ((int)(System.Convert.ChangeType(listToolStripTextBox3.Text, typeof(int)))));
            }
            catch (System.Exception ex)
            {
                System.Windows.Forms.MessageBox.Show(ex.Message);
